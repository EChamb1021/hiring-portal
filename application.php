    ...
    <form id="application" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        ...
        <div class="form-field">
            ...
            <select name="province" id="province">
                ...
                <option value="Alberta" <?php if (isset($_POST['province']) && $_POST['province'] == "Alberta") echo 'selected';?>>Alberta</option>
                <option value="British Columbia" <?php if (isset($_POST['province']) && $_POST['province'] == "British Columbia") echo 'selected';?>>British Columbia</option>
                <option value="Manitoba" <?php if (isset($_POST['province']) && $_POST['province'] == "Manitoba") echo 'selected';?>>Manitoba</option>
                <option value="New Brunswick" <?php if (isset($_POST['province']) && $_POST['province'] == "New Brunswick") echo 'selected';?>>New Brunswick</option>
                <option value="Newfoundland and Labrador" <?php if (isset($_POST['province']) && $_POST['province'] == "Newfoundland and Labrador") echo 'selected';?>>Newfoundland and Labrador</option>
                <option value="Nova Scotia" <?php if (isset($_POST['province']) && $_POST['province'] == "Nova Scotia") echo 'selected';?>>Nova Scotia</option>
                <option value="Ontario" <?php if (isset($_POST['province']) && $_POST['province'] == "Ontario") echo 'selected';?>>Ontario</option>
                <option value="Prince Edward Island" <?php if (isset($_POST['province']) && $_POST['province'] == "Prince Edward Island") echo 'selected';?>>Prince Edward Island</option>
                <option value="Quebec" <?php if (isset($_POST['province']) && $_POST['province'] == "Quebec") echo 'selected';?>>Quebec</option>
                <option value="Saskatchewan" <?php if (isset($_POST['province']) && $_POST['province'] == "Saskatchewan") echo 'selected';?>>Saskatchewan</option>
            </select>
        </div>
        <div class="form-field">
        ...
        <div class="form-field">
            ...
            <input name="start-date" type="date" id="start-date" value="<?php echo isset($_POST['start-date'])? $_POST['start-date']:''; ?>">
        </div>
        <div class="form-field">
            ...
            <input name="salary" type="text" id="salary" value="<?php echo isset($_POST['salary'])? $_POST['salary']:''; ?>">
        </div>
        <div class="form-field">
            <label for="portfolio" id="portfolio">
                Portfolio
            </label>

            <input name="portfolio" type="text" id="portfolio" value="<?php echo isset($_POST['portfolio'])? $_POST['portfolio']:''; ?>">
        </div>
        <div class="form-field">
            <label for="linkedin" id="linkedin">
                LinkedIn Profile
            </label>
        ...
        <div class="form-field">
            ...
            <input name="experience" type="text" id="experience" value="<?php echo isset($_POST['experience'])? $_POST['experience']:''; ?>">
        </div>
        <div class="form-field">
